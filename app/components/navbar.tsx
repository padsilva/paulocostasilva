...
export function Navbar() {
  ...
  return (
    <nav
      className={clsx(
        "fixed w-full z-10 2xl:px-48 xl:px-36 py-4 flex justify-between items-center bg-slate-100 dark:bg-slate-900 border-b border-b-gray-200 dark:border-b-gray-800",
