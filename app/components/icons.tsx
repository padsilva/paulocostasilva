...
export function LinkedIn({ size = 24 }: { size?: number } = {}) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function Construction({ size = 24 }: { size?: number } = {}) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function MoveUp({ size = 24 }: { size?: number } = {}) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export function CodeXml({ size = 24 }: { size?: number } = {}) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function Blocks({ size = 24 }: { size?: number } = {}) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function Workflow({ size = 24 }: { size?: number } = {}) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function RefreshCcw({ size = 24 }: { size?: number } = {}) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function Users({ size = 24 }: { size?: number } = {}) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function ExternalLink({ size = 16 }: { size?: number } = {}) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
